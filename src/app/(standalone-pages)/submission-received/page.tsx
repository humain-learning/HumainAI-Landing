	...
	<div className="flex items-center justify-center bg-white px-4">
      	<div className="max-w-2xl w-full rounded-2xl border p-10 text-center shadow">
        	...
        	<p className="text-gray-700 mb-6 text-base md:text-lg">
         		Your submission was successful. You shall receive the details shortly.
       	 	</p>
        ...
        <p className="mt-6 text-sm text-gray-500">If you don't hear from us within 48 hours, please check your registered email's spam folder or contact us at <a href="mailto:hi@humainlearning.ai">hi@humainlearning.ai</a> </p>
      </div>
    </div>
	</>
