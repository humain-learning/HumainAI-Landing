...
export const Hero = () => {
        return (
            <div className=" relative w-full flex-col md:flex-row max-w-screen flex items-center z-10">
                <img 
                            src='/assets/Website Assets/Bubble.svg' 
                            // Position absolute relative to the section
                            className="absolute sm:hidden md:visible bottom-0 right-0 z-1 h-auto w-[80vw] md:w-[43vw] object-contain" 
                        />
                <div className="relative w-full md:w-[90vw] flex flex-col md:flex-row items-center justify-center mx-auto">
                    ...
                    <div className=''>
                        <ul className="space-y-2 pl-5 text-base md:text-lg">
                    ...
                    <div className="pt-6 pb-3 px-6 font-medium">
                        Early Bird Offer!
                        <br />
                        <span className=" p-1 text-2xl md:text-4xl font-bold text-terracotta">&#8377;9440</span><span className="p-1 text-lg md:text-2xl line-through text-gray-500 pl-3">&#8377;11,800</span><span className="p-1 text-sm md:text-base text-gray-500">incl. GST</span>
                    </div>
                    <div className="flex flex-col md:flex-row items-center justify-center px-5 pt-2 pb-5 gap-4 md:gap-0">
