...
import { sneakpeekLink } from "./data";
        ...
        <div className="py-10">
            <div className="flex flex-col justify-center items-center px-5">
                <h1 className="text-4xl md:text-6xl font-semibold flex flex-col justify-center text-center py-6 md:py-10">                    
                    <span className='text-sage'>A Sneak Peek <br/>Into Our Fun</span>
                    <span className='text-terracotta'>& Interactive Classes</span>
                </h1>
                <hr className="w-1/2 md:w-1/4 lg:w-1/8 border-t-4 border-terracotta mx-6 mb-10" />
            </div>
            <div className="relative w-full md:w-[80vw] lg:w-[70vw] h-auto mx-auto px-5">
