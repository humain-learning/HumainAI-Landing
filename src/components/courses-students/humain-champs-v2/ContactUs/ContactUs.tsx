    ...
    return (
        <div id='contact-us' className="flex flex-col md:flex-row w-[90vw] bg-white rounded-lg mx-auto py-5 md:py-10 items-start justify-between">
            ...
            <div className="flex px-3 md:px-6 flex-col w-full md:w-[50%]">
                <h1 className='text-4xl md:text-6xl font-semibold text-start py-5'>
                    <span className="text-sage">Contact Us</span>
                </h1>
            	<hr className="w-1/2 md:w-1/4 lg:w-1/8 border-t-4 border-terracotta" />
                <div className='flex w-full flex-col md:gap-0'>
                    <div className='w-full flex items-center justify-start gap-5 py-5'>
                        <img src='/assets/Website Assets/Call.svg' className="w-1/5 md:scale-70" />
                        <span className='text-lg md:text-2xl font-medium'>+91 81300 23688</span>
                    </div>
                    <div className='w-full flex items-center justify-start gap-5 py-5 '>
                        <img src='/assets/Website Assets/Mail.svg' className="w-1/5 md:scale-70" />
                        <span className='text-lg md:text-2xl font-medium'>hi@humainlearning.ai</span>
                    </div>
                </div>
            </div>
