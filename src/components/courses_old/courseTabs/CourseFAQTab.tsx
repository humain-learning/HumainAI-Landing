...
export const CourseFAQTab = () => {
  return (
    <div className="px-4 pt-5 pb-4">
      <h4 className="pb-4 text-2xl font-medium">Frequently Asked Questions</h4>

      <div>
        <div className="h-full space-y-3 rounded-2xl border border-[#E0E0E0] p-4">
          <Accordion
            items={AI_JOURNEY}
            className="space-y-4"
            isCustomTabColor
