export const takeHomeItems = [
  {
    id: 'family-tribute-video-kit',
    icon: 'video',
    title: 'Live 2-hour hands-on webinar',
    description: 'Build-along session with live Q&A and feedback',
    price: '₹699',
    image: '/assets/webinar/takehome/Live2hour.png',
  },
  {
    id: 'ai-toolkit-bundle',
    icon: 'toolkit',
  ...
  //   description: 'Shareable certificate from Humain Learning for every student',
  //   price: 'Included',
  //   image: '/assets/webinar/takehome/Certificate.png',
  // },
];
