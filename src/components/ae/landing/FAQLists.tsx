...
const ENTITY_FAQ = [
  {
    ...
    content: (
      <div>
        Humain Learning is an AI literacy course provider for students aged 13–18 and their teachers,
        operated by Eduxa Consulting. The work runs across two programmes (HumainChamps for students and HumainEducators for teachers) and is built on the six-pillar Humain AI Literacy Framework adapted from UNESCO, OECD, and EU references.
