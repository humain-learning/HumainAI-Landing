...
const Testimonial = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-6 px-6 pt-10 pb-14 text-[#011813] md:px-0 lg:space-y-[50px]">
      ...
      <div className="">
        {/* <div className="relative mx-auto h-[160px] w-full max-w-4xl overflow-hidden lg:h-[280px]">
          <motion.div
            animate={{ rotate: 360 }}
            transition={{
              repeat: Infinity,
              ...
              >
                <div className="items-cet flex gap-2">
                  ...
                  <div>
                    ...
                    {item?.class && (
                      <p className="text-xs text-[#4E5255]">
                        {item.class}
                      </p>
                    )}
                    {/* {item.school && (
