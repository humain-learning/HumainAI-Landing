          ...
          <div className="flex items-center gap-4">
            <a href="#download" onClick={(e) => scrollTo(e, 'download')} className="hidden md:inline-block">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="flex cursor-pointer items-center gap-2 rounded-full bg-[#5e714e] py-2 px-5 text-white shadow-md transition-all duration-300 hover:bg-[#4a5a3e]"
              >
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <a
              ...
              className="w-full text-center mt-2 bg-[#5e714e] py-3 rounded-full text-white font-bold"
            >
              Download free PDF
            </a>
          </motion.div>
