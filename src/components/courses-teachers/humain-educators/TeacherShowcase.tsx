...
import 'swiper/css';
import { testimonialVideos } from "./data/teachershowcase";
...
export const TeacherShowcase = () => {
    ...
    <div className="relative flex flex-col items-center justify-center mx-auto py-6 md:py-10">
        <div className="w-full md:w-[90vw] flex flex-col items-start justify-center mx-auto">
            <h1 className="text-4xl md:text-6xl w-full font-semibold px-3 md:px-6 py-5 md:py-5">
                <span className=" text-sage">Teacher Showcase</span>
            </h1>
