      ...
      <div className="mx-auto w-full max-w-6xl px-6 md:px-12 lg:px-16 flex flex-col items-center">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <motion.div 
            ...
            className="bg-[#f9faf7] rounded-3xl p-8 lg:p-10 border border-[#e8efe0] shadow-sm flex flex-col items-center text-center"
          >
            <div className="w-20 h-24 bg-white border-2 border-[#e8efe0] rounded-lg shadow-md mb-6 flex items-center justify-center relative overflow-hidden">
            ...
            <Link 
              ...
              className="inline-flex w-full items-center justify-center px-8 py-4 rounded-full bg-terracotta text-white font-sans font-bold text-base shadow-lg shadow-terracotta/30 hover:bg-[#d6925c] transition-all duration-300"
            >
          ...
          >
            <div className="w-20 h-24 bg-white border-2 border-[#e8efe0] rounded-lg shadow-md mb-6 flex items-center justify-center relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-4 bg-[#5e714e]" />
              <span className="font-display font-bold text-charcoal/30 text-xs mt-2">PDF</span>
            </div>
            ...
            <Link 
              ...
              className="inline-flex w-full items-center justify-center px-8 py-4 rounded-full bg-[#5e714e] text-white font-sans font-bold text-base shadow-lg shadow-[#5e714e]/30 hover:bg-[#4a5a3e] transition-all duration-300"
            >
