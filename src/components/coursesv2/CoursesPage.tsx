    ...
    <section>
      <div className=" relative w-full flex-row max-w-screen flex items-center z-10">
        <img 
                  ...
                  className="absolute bottom-0 right-0 z-1 h-auto w-[45vw] object-contain" 
              />
        <div className="relative w-[90vw] flex items-center justify-center grid-cols-2 mx-auto">
        <div className="flex-col mx-auto w-1/2 sm:px-6 z-10 w">
          ...
          <div className="flex flex-row items-center justify-left px-5 pt-2 pb-5 grid-cols-2">
      ...
      <div className="bg-sage w-full text-white py-2">
        <div className="flex max-w-[85vw] items-center justify-between mx-auto grid-cols-3">
